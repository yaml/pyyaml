...
__all__ = ['BaseResolver', 'Resolver', 'CoreResolver', 'JSONResolver']
...
class CoreResolver(BaseResolver): pass

class JSONResolver(BaseResolver): pass

Resolver.init_resolvers('yaml11')
CoreResolver.init_resolvers('core')
JSONResolver.init_resolvers('json')
